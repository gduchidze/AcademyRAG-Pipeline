...
def mock_qdrant_search(query_vector, collection_name, limit, score_threshold, with_payload):
    ...
    mock_data = [
        {
            'id': 1,
            'payload': {
                'text': """ნეირონული ქსელები არის მანქანური სწავლების მოდელი, რომელიც ადამიანის ტვინის მუშაობის პრინციპზეა დაფუძნებული. 
                    ის შედგება ხელოვნური ნეირონებისგან, რომლებიც ერთმანეთთან დაკავშირებულია და ქმნის ქსელს. თითოეული ნეირონი იღებს 
                    შემავალ სიგნალებს, ამუშავებს მათ და გადასცემს შემდეგ ნეირონს.""",
        ...
        },
        {
            'id': 2,
            'payload': {
                'text': """წრფივი რეგრესია არის მარტივი მოდელი, რომელიც გამოიყენება ორ ცვლადს შორის წრფივი დამოკიდებულების 
                    საპოვნელად. მაგალითად, ბინის ფართობსა და ფასს შორის კავშირის დასადგენად.""",
                'file': 'linear_regression.md'
            },
            'score': 0.85
        },
        {
            'id': 3,
            'payload': {
                'text': """მანქანური სწავლების ალგორითმები იყოფა სამ ძირითად კატეგორიად: supervised learning, unsupervised learning 
                    და reinforcement learning. თითოეულ მათგანს აქვს თავისი გამოყენების სფერო და უპირატესობები.""",
                'file': 'ml_types.md'
            },
            'score': 0.75
        },
        {
            'id': 4,
            'payload': {
                'text': """ტრანსფორმერების არქიტექტურა არის ნეირონული ქსელის ტიპი, რომელიც გამოიყენება ენის მოდელებში. 
                    მისი მთავარი კომპონენტებია self-attention მექანიზმი, რომელიც საშუალებას აძლევს მოდელს ფოკუსირება მოახდინოს 
                    შემავალი ტექსტის სხვადასხვა ნაწილზე.""",
